...
from sitespawner.generate import generate
from sitespawner.update_style import update_style
...
def update_webpage(
    ...
    for root_str, dirs, files in os.walk(legacy_page_dir):
        root = Path(root_str)
