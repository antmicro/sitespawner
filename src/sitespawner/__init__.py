...
from sitespawner.common import get_logger, root_dir, set_loglevel
from sitespawner.convert_data import convert_data
from sitespawner.gen_coverage_report import main as gen
from sitespawner.update_webpage import update_webpage
...
def create_subparser(subparsers, name, description, help_text, args_list, handler):
    """
...
def reports_handler(args):
    if Path(root_dir).absolute == Path(args.report_dir).absolute:
        msg = f"Existing webpage root and output paths mustn't be the same: {args.root}"
...
def setup_parser():
    ...
    create_subparser(
        ...
        help_text="Convert Verilator's *.dat coverage files into *.info files",
    ...
    logo_src = {
        ...
        "options": {
            ...
            "help": "Path to logo to be attached with the report, relative to index.html file in the destination dir.",  # noqa: E501
        },
    }
    logo_href = {
        "name": "--logo-href",
    ...
    src_remove_pattern = {
        ...
        "options": {
            ...
            "default": None,
            "type": str,
            "help": "Pattern used for removing designs' source files from coverage report generation.",  # noqa E501
        },
    }
    src_path = {
        "name": "src_path",
    ...
    create_subparser(
        ...
        help_text=("Gathers *.info files and generates the collective HTML coverage dashboard."),
    ...
    page_url = {
        ...
        "options": {
            "type": str,
            "metavar": "page_url",
            "help": "Base URL of the website. Otherwise, will apply relative reference for redirect.",  # noqa: E501
        },
    }
    doc_project_name = {
    ...
    create_subparser(
        ...
        help_text="Update webpage based on GitHub refs and events.",
    ...
    create_subparser(
        ...
        help_text="Perform data conversion, coverage dashboard generation and assemble the webpage.",  # noqa: E501
